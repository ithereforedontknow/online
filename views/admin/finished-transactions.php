...
<div class="offcanvas offcanvas-end w-50" tabindex="-1" id="editFinishedTransactionOffcanvas" aria-labelledby="editTransactionLabel">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="editTransactionLabel">Edit <span class="fw-bold">Finished</span> transaction</h5>
